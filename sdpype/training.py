        ...
        match model_name:
            ...
            case "dpgan":
                ...
                model = Plugins().get("dpgan",
                    ...
                    epsilon=model_params.get("epsilon", 1.0),
                    delta=model_params.get("delta", None),
                    dp_max_grad_norm=model_params.get("dp_max_grad_norm", 2.0),
                    dp_secure_mode=model_params.get("dp_secure_mode", False),
